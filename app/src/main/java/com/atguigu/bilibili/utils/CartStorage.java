...
public class CartStorage {
    ...
    private void listToSparesArray() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            sparseArray.put(Integer.parseInt(goodsBean.getSkuId() + ""), goodsBean);
        }
    }
    ...
    public void addData(GoodsBean goodsBean) {
        //1.添加数据到sparseArray
        GoodsBean tempGoodsBean = sparseArray.get(Integer.parseInt(goodsBean.getSkuId() + ""));
        ...
        //添加到集合中
        sparseArray.put(Integer.parseInt(goodsBean.getSkuId() + ""), tempGoodsBean);
    ...
    public void daleteData(GoodsBean goodsBean) {
        sparseArray.delete(Integer.parseInt(goodsBean.getSkuId() + ""));
        saveLocal();
    }
    ...
    public GoodsBean findDete(int product_id) {
