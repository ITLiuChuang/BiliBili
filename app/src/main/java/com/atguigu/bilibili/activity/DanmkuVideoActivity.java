...
import com.atguigu.bilibili.video.DanmakuVideoPlayer;
import com.atguigu.bilibili.video.listener.SampleListener;
...
public class DanmkuVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.ic_feed_bottom_empty);
